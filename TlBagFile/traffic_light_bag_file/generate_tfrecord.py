...
flags = tf.app.flags
flags.DEFINE_string('csv_input', 'traffic_light_labels.csv', 'Path to the CSV input')
flags.DEFINE_string('output_path', 'output/tlbagtrainrecord/train.record', 'Path to output TFRecord')
flags.DEFINE_string('image_dir', 'labeledImages', 'Path to images')
FLAGS = flags.FLAGS
...
def create_tf_example(group, path):
    ...
    for index, row in group.object.iterrows():
        ...
        classes.append(int(LABEL_DICT[row['class']]))
